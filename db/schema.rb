...
ActiveRecord::Schema.define(version: 20160102124314) do
  ...
  add_index "categories", ["tasks_count"], name: "index_categories_on_tasks_count", using: :btree
  ...
  add_index "task_comments", ["to_user_id"], name: "index_task_comments_on_to_user_id", using: :btree
  ...
  add_index "task_stars", ["task_id", "user_id"], name: "index_task_stars_on_task_id_and_user_id", using: :btree
  ...
  add_index "task_views", ["task_id", "ip", "created_at"], name: "index_task_views_on_task_id_and_ip_and_created_at", using: :btree
  ...
  add_index "tasks", ["comments_count"], name: "index_tasks_on_comments_count", using: :btree
  add_index "tasks", ["created_at"], name: "index_tasks_on_created_at", using: :btree
  add_index "tasks", ["star_count"], name: "index_tasks_on_star_count", using: :btree
  add_index "tasks", ["title"], name: "index_tasks_on_title", using: :btree
  add_index "tasks", ["user_id"], name: "index_tasks_on_user_id", using: :btree
  add_index "tasks", ["view_count"], name: "index_tasks_on_view_count", using: :btree
